        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control col-sm-10" name="asal" id="asal" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jk" id="laki-laki" value="1" required>
                            <label class="form-check-label" for="laki-laki">
                                Laki - laki
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jk" id="perempuan" value="2" required>
                ...
                <!-- <div class="form-group row">
                    ...
                    <select class="form-control col-sm-10" name="pendidikan" id="pend" required>
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control col-sm-3" name="kategori" enabled='false' required>
                    ...
                    <select class="form-control col-sm-3" name="divisi" enabled='false' required>
                    ...
                    <select class="form-control col-sm-3 pilihkaryawan" name="unit" required>
                    ...
                    <select class="form-control col-sm-3 pilihkaryawan" name="subunit" id="subunit" required>
                        <option value="" selected>Pilih</option>
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control col-sm-10" name="grup_t" id="grup_t" required>
                        <option value="" selected>Pilih</option>
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control col-sm-10" name="jabatan" id="jabatan" required>
                        <option value="" selected>Pilih</option>
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control col-sm-10" name="golongan" id="golongan" required>
                        <option value="" selected>Pilih</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" value="" name="tmt"
                            id="tmt" required>
                    </div>
                </div>
                <!-- /.card-body -->
