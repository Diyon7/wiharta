        ...
        <div class="widget-header widget-header-small">
            ...
            <div class="widget-toolbar">
                ...
                <a href="#" data-action="collapse">
                    <i class="ace-icon fa fa-chevron-up" data-icon-show="fa fa-chevron-down" data-icon-hide="fa fa-chevron-up"></i>
                </a>
                    ...
                    <ul class="list-unstyled spaced2">
                        <form class="form-horizontal" action="" method="post" role="form">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for=""><b align="center">Tanggal</b></label>

                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-group">
                                        <input class="form-control date-picker" name="fnama" value="<?php echo $p_tanggal; ?>" id="fnama" type="text" data-date-format="yyyy-mm-dd" required />
                            ...
                            <div class="form-group" align="center">
                                ...
                                <div class="col-xs-12 col-sm-11">
                                    ...
                                    <input type="submit" class="btn btn-info" name="tb_act" id="tampilkan" value="Tampil" />
                                    <a href="pegawai/absrekap.php?fnama=<?php echo $p_tanggal; ?>" class="btn btn-danger" target="_blank">Cetak</a>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control date-picker" name="ptgl1" value="<?php echo $ptgl1; ?>" id="fnama" type="text" data-date-format="yyyy-mm-dd" required />
                                        <span class="input-group-addon">
                                            <i class="fa fa-calendar bigger-110"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control date-picker" name="ptgl2" value="<?php echo $ptgl2; ?>" id="fnama" type="text" data-date-format="yyyy-mm-dd" required />
                                        <span class="input-group-addon">
                                            <i class="fa fa-calendar bigger-110"></i>
                                        </span>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <select class="form-control select2" name="pid1" id="pid1" style="width: 100%;">
                                        ...
                                        <?php while ($data2 = mysqli_fetch_array($db2)) { ?>
                                            <option value="<?php echo $data2['kartu']; ?>"><?php echo $data2['kartu']; ?> / <?php echo $data2['nama']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                </br><label class="col-sm-3 control-label no-padding-right" for=""></label>
                                <div class="col-xs-12 col-sm-6" align="center">
                                    <input type="submit" class="btn btn-info" name="tb_act" id="proses" value="Proses" />
                                    <a href="pegawai/abskar.php?pid1=<?php echo $pid1; ?>&ptgl1=<?php echo $ptgl1; ?>&ptgl2=<?php echo $ptgl2; ?>" class="btn btn-danger" target="_blank">Cetak</a>
...
where resign=0 and grup in ('GK01','GKNS') and sub_unit2.lokasi in ('2a','2b')");
                            ...
                            while ($datas1 = mysqli_fetch_array($tampils1)) { ?>
                                ...
                                from tb_karyawan a, 
                                     tb_jadwal1 b 
                                            ...
                                            and resign=0                                            
                                            and a.grup not in ('GK02','GK01','GKNS')");
                                                                while ($datas1r = mysqli_fetch_array($tampils1r)) {
                                                                    echo  $datas1r['total'];
                                                                    $datadevsi1r = $datas1r['total'];
                                                                } ?></b> <?php } else if (getDayIndonesia($hari_ini) == "Minggu") { ?>
                            ...
                            while ($datas12 = mysqli_fetch_array($tampils1)) { ?>
                                <tr>
                                    ...
                                    <td><?php if (getDayIndonesia($hari_ini) == "Senin") { ?>
                                        ...
                                        <?php } else { ?> <?php echo  $datas12['totala3'];
                                                    } ?></td>
                    ...
                    group by d.kartu) as jmll");
                                ...
                                <tr>
                                    <td><b>TOTAL I</b></td>
                                    <td><?php if (getDayIndonesia($hari_ini) == "Senin") { ?>
                                            <b><?php $jmlk = $datas2b + $datadevsm1 + $datadevsi1 + $datadevsii1 + $datadevsiii1;
                                                echo $jmlk; ?></b>
                                            <b class='red' hidden><?php $jmlk2 = $datas2b + $datadevsm1 + $datadevsi1r + $datadevsii1 + $datadevsiii1;
                                                                    echo $jmlk2; ?></b>
                                        <?php } else if (getDayIndonesia($hari_ini) == "Minggu") { ?>
                                            <b><?php $jmlk = $datas2b + $datadevsm1 + $datadevsi1 + $datadevsii1 + $datadevsiii1;
                                                echo $jmlk; ?> </b>
                                            (<b class='red'><?php $jmlk2 = $datas2b + $datadevsm1 + $datadevsi1r + $datadevsii1 + $datadevsiii1;
                                                            echo $jmlk2; ?></b>)
                                    ...
                                    <td><b><?php $jmlk2 = $hsl2 + $hsm1 + $hsi2 + $hsii2 + $hsiii2;
                                            echo $jmlk2; ?></b></td>
                                    <td><?php if (getDayIndonesia($hari_ini) == "Minggu") { ?>
                                            <b><?php $jmlk3 = $hsi1 + $hsii1 + $hsiii1;
                                                echo $jmlk3; ?></b>
                                        <?php } else if (getDayIndonesia($hari_ini) == "Sabtu") { ?>
                                            <b><?php $jmlk3 = $hsl1 + $hsm2 + $hsi1 + $hsii1 + $hsiii1;
                                                echo $jmlk3; ?></b>
                                        <?php } else { ?>
                                            <b><?php $jmlk3 = $hsl1 + $hsm2 + $hsi1 + $hsii1 + $hsiii1;
                                                echo $jmlk3;
                    ...
                    group by d.kartu) as jmll");
                            ...
                            <tr>
                                <td><b>TOTAL II</b></td>
                                <td><?php if (getDayIndonesia($hari_ini) == "Senin") { ?>
                                        <b><?php $jmlk3 = $datas2b + $datadevsm1 + $datadevsi1r + $datadevsii1 + $datadevsiii1 + $datadevsiii0;
                                            echo $jmlk3; ?></b>
                                    <?php } else if (getDayIndonesia($hari_ini) == "Minggu") { ?>
                                        <b><?php $jmlk3 = $datas2b + $datadevsm1 + $datadevsi1r + $datadevsii1 + $datadevsiii1 + $datadevsiii0;
                                            echo $jmlk3; ?></b>
                                    <?php } else if (getDayIndonesia($hari_ini) == "Sabtu") { ?>
                                        <b><?php $jmlk = $datas2b + $datadevsm1 + $datadevsi1 + $datadevsii1 + $datadevsiii1 + $datadevsiii0;
                                            echo $jmlk; ?></b>
                                    <?php } else { ?><b><?php $jmlk = $datas2b + $datadevsm1 + $datadevsi1 + $datadevsii1 + $datadevsiii1 + $datadevsiii0;
                                                            echo $jmlk; ?></b> <?php } ?>
                                </td>
                                <td><b><?php $jmlk2 = $hsl2 + $hsm1 + $hsi2 + $hsii2 + $hsiii2;
                                        echo $jmlk2; ?></b></td>
        ...
        <div class="widget-box widget-color-orange collapsed">
            <div class="widget-header widget-hea1der-small">
                ...
                <div class="widget-toolbar">
                    Klik disini
                    <a href="#" data-action="collapse">
                        <i class="ace-icon fa fa-chevron-down" data-icon-show="fa fa-chevron-down" data-icon-hide="fa fa-chevron-up"></i>
                    </a>
                            ...
                            ?>
                                <div class="itemdiv dialogdiv">
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="name">
                                            <a href="?id=vwprofil&id_n=<?php echo $b['NOMOR_ID']; ?>" title="Klik Untuk View Profile"><?php echo $b['NAMA']; ?></a>
                                        </div>
                                        ...
                                        <div class="tools">
                                            <a data-toggle="modal" data-target="#<?php echo $b['NOMOR_ID']; ?>" href="#" class="btn btn-minier btn-info" title="Kirim Pesan Ucapan Ultah">
...
WHERE g.id_mesin=h.id and g.id_mesin  and g.resign=0 and g.grup='$grup' and h.waktu between '" . $p_tanggal . " 05:00:00' and '" . $p_tanggal . " 13:00:00')");
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
                            ...
                            <tr>
                                <td colspan='6'>
                                    <h3 class="panel-title"><b> Karyawan Sabtu Libur </b><?php echo "Tanggal : " . $p_tanggal . "<br/> " . $lalamat; ?></h3>
                                </td>
                            </tr>
                            ...
                            ?>
                                ...
                                while ($data = mysqli_fetch_array($tampil3)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="?id=formcuti&mod=add&id_n=<?php echo $idn0; ?>" target="_blank" title="Lihat Detail"><?php echo $data['nama']; ?></a></td>
...
WHERE g.id_mesin=h.id and g.id_mesin  and g.resign=0 and g.grup in ('GK01','GKNS') and h.waktu between '" . $p_tanggal . " 05:00:00' and '" . $p_tanggal . " 10:00:00')");
                            ...
                            <tr>
                                <td colspan='6'>
                                    <h3 class="panel-title"><b> Karyawan Sabtu Masuk </b><?php echo "Tanggal : " . $p_tanggal . "<br/> " . $lalamat; ?></h3>
                                </td>
                            </tr>
					...
					group by d.kartu order by d.sub_unit");
                            ...
                            <tr>
                                <td colspan='6'>
                                    <h3 class="panel-title"><b> Group Shift 1 </b><?php echo "Tanggal : " . $p_tanggal . "<br/> " . $lalamat; ?></h3>
                                </td>
                            </tr>
                            <?php
                            $q_libur = mysqli_query($mysqli, "SELECT * FROM tbl_libur WHERE tgllibur = '" . $p_tanggal . "' ");
                            ...
                            ?>
                                ...
                                while ($data = mysqli_fetch_array($tampil3)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="?id=formcuti&mod=add&id_n=<?php echo $idn0; ?>" target="_blank" title="Lihat Detail"><?php echo $data['namaz']; ?></a></td>
					...
					");
                            ...
                            <tr>
                                <td colspan='6'>
                                    <h3 class="panel-title"><b> Group Shift 2 </b><?php echo "Tanggal : " . $fnama3 . "<br/> " . $lalamat; ?></h3>
                                </td>
                            </tr>
					...
					group by d.kartu order by d.sub_unit");
                            ...
                            <tr>
                                <td colspan='6'>
                                    <h3 class="panel-title"><b> Group Shift 3 </b><?php echo "Tanggal : " . $fnama3 . "<br/> " . $lalamat; ?></h3>
                                </td>
                            </tr>
                            <?php
                            $q_libur = mysqli_query($mysqli, "SELECT * FROM tbl_libur WHERE tgllibur = '" . $fnama3 . "' ");
                ...
                <div class="widget-main">
                    <div class="table-responsive">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
                            ...
                            <?php $n = 0;
                            while ($data = mysqli_fetch_array($tampilai)) {
                                $n++  ?>
                                <tr>
                                    <td><?php echo $n; ?></td>
                                    <td><?php echo $data['kar']; ?></td>
...
ORDER BY tgl ");
                    ...
                    ?>
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" width="20%">
                            <tr>
                                <td>
                                    <label>PERIODE </label>
                                </td>
                    ...
                    <div class="table-responsive">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
                            ...
                            ?>
                                <tr <?php if ($data['shift'] == 0) {
                                        echo "bgcolor='grey'";
                                    } ?>>
                                    <td><?php echo $n; ?></td>
                                    <td><?php echo $hari; ?></td>
                                    <td align="center"><?php $dtd = $data['tgl'];
                                                        echo $dtd; ?></td>
                                    <td align="center"><?php $sf = $data['shift'];
                                                        echo $data['shift']; ?></td>
                                    <td align="center"><?php if ($gr == 'GK02') {
                                                            echo '07:50:00';
                                                        } else {
                                                            echo $data['masuk'];
                                                        } ?></td>
                                    ...
                                    <td align="center"><?php if ($sf == 1) {
                                                            $sr1 = mysqli_query($mysqli3, "SELECT MIN(DATE_FORMAT(waktu,'%H:%i:%s')) as timedat FROM LOG WHERE id='" . $idmes . "'
					AND DATE_FORMAT(waktu,'%Y-%m-%d') ='" . $dtd . "' AND DATE_FORMAT(waktu,'%H:%i:%s') <= '14:00:00';");
                                                        ...
                                                        if ($sf == 2) {
                                                            $sr2 = mysqli_query($mysqli3, "SELECT MIN(DATE_FORMAT(waktu,'%H:%i:%s')) as timedat FROM LOG WHERE id='" . $idmes . "'
					AND DATE_FORMAT(waktu,'%Y-%m-%d') ='" . $dtd . "' AND DATE_FORMAT(waktu,'%H:%i:%s') <= '19:00:00';");
                                                        ...
                                                        if ($sf == 3) {
                                                            $sr3 = mysqli_query($mysqli3, "SELECT max(DATE_FORMAT(waktu,'%H:%i:%s')) as timedat FROM LOG WHERE id='" . $idmes . "'
					AND DATE_FORMAT(waktu,'%Y-%m-%d') ='" . $dtd . "' AND DATE_FORMAT(waktu,'%H:%i:%s') <= '23:59:59';");
                                    ...
                                    <td>
                                        <?php if ($sf == 1) {
                                            $sr4 = mysqli_query($mysqli3, "SELECT MAX(DATE_FORMAT(waktu,'%H:%i:%s')) as timedat FROM LOG WHERE id='" . $idmes . "'
					AND DATE_FORMAT(waktu,'%Y-%m-%d') ='" . $dtd . "' AND DATE_FORMAT(waktu,'%H:%i:%s') > '12:00:00';");
                                        ...
                                        if ($sf == 2) {
                                            $sr5 = mysqli_query($mysqli3, "SELECT MAX(DATE_FORMAT(waktu,'%H:%i:%s')) as timedat FROM LOG WHERE id='" . $idmes . "'
					AND DATE_FORMAT(waktu,'%Y-%m-%d') ='" . $dtd . "' AND DATE_FORMAT(waktu,'%H:%i:%s') > '19:00:00';");
                                        ...
                                        if ($sf == 3) {
                                            $sr6 = mysqli_query($mysqli3, "SELECT MIN(DATE_FORMAT(waktu,'%H:%i:%s')) as timedat FROM LOG WHERE id='" . $idmes . "'
					AND DATE_FORMAT(waktu,'%Y-%m-%d') =DATE_ADD('" . $dtd . "', INTERVAL 1 DAY) AND DATE_FORMAT(waktu,'%H:%i:%s') > '03:00:00';");
                                    ...
                                    <td align="center">
                                        <?php if ($sf == 1) {
                                            ...
                                            $gr2 = mysqli_query($mysqli3, "SELECT TIMEDIFF(time('14:51:00'),
                                            ...
                                            $gr3 = mysqli_query($mysqli3, "SELECT TIMEDIFF(time('22:51:00'),
