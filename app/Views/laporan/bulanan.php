        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    $jammasuk = '14:50:00';
                    $jammasuk2 = '15:00:00';
                    $jampulang = strtotime('23:00:00');
                    $wk = (strtotime(date('H:i', strtotime($jammasuk2))))  - (strtotime(date('H:i', strtotime($jammasuk))));
                    $toterlambat = floor($wk  / 60);
                    print_r(date('H:i', strtotime($jammasuk2)));
                    echo '<br>';
                    print_r(date('H:i', strtotime($jammasuk)));
                    echo '<br>';
                    print_r($toterlambat);
                    ?>
                </h3>
