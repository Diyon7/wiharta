    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <?php if (has_permission('exim')) : ?>
                <?php if (isset($jumlahuserbc)) : ?>

                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        <i class="far fa-user"></i>
                        <span class="badge badge-warning navbar-badge"><?= $jumlahuserbc ?></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <span class="dropdown-item dropdown-header">Jumlah Login</span>
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item">
                            <i class="fas fa-globe mr-2"></i><?= $jumlahuserbc ?> Beacukai
                            <span class="float-right text-muted text-sm"><?= $loginterakhirloginbc ?></span>
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="<?= base_url() ?>/admin/exim/userloginbc" class="dropdown-item dropdown-footer">See All
                            Login</a>
                    </div>
                </li>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <?php if (has_permission('datalaporan')) : ?>
                                <li class="nav-item">
                        ...
                        <?php endif ?>
                        <?php if (has_permission('pengecualian')) : ?>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/karyawan/validasikaryawan"
                                        class="nav-link <?= $halaman == 'Validasi Ganti Shift' ? 'active' : 'DASHBOARD SDM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>validasi Karyawan Baru</p>
                                    </a>
                                </li>
                            </ul>
                            <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php if (has_permission('datalaporan')) : ?>
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/karyawan/nambahkaryawan"
                                        class="nav-link <?= $halaman == 'Tambah Karyawan' ? 'active' : 'DASHBOARD SDM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>TAMBAH KARYAWAN</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/mutasi/mutasiproduksi"
                                        class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Mutasi Produksi</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/mutasi/mutasiekspor"
                                        class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Export</p>
                                    </a>
                                ...
                                <!-- <li class="nav-item">
                                        <a href="<?= base_url() ?>/maintenance" class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                            <i class="far fa-file nav-icon"></i>
                                            <p>Export</p>
                                        </a>
                                    </li> -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/jurnal/jurnalpembelian"
                                        class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/jurnal/jurnalpenjualan"
                                        class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/jurnal/jurnalpenerimaanbank"
                                        class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Jurnal Penerimaan Bank</p>
                                    </a>
                                </li>
                                <!-- <li class="nav-item">
                                        <a href="<?= base_url() ?>/maintenance" class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/jurnal/jurnalpengeluaranbank"
                                        class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Jurnal Pengeluaran Bank</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-header">ITV</li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-chart-pie"></i>
                                <p>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/exim/importbahanbaku"
                                        class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Data</p>
                                    </a>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url() ?>/admin/exim/wkaitv"
                                class="nav-link <?= $halaman == 'Karyawan' ? 'active' : 'DASHBOARD SDM' ?>">
                                <i class="far fa-file nav-icon"></i>
                                <p>TRANSFER KITE</p>
                            </a>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/exim/bclktitv"
                                        class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>BCLKT ITV</p>
                                    </a>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/exim/negara"
                                        class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Negara</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/exim/delterm" class="nav-link">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Del Term</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/exim/kemasan" class="nav-link">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Kemasan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/exim/produk" class="nav-link">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Produk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/exim/satuan" class="nav-link">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Satuan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/exim/tipeproduksi" class="nav-link">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Tipe Produksi</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item d-flex">
                                    <a href="<?= base_url() ?>/admin/exim/port" class="nav-link">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Port</p>
                                    </a>
                                </li>
                                <li class="nav-item d-flex">
                                    <a href="<?= base_url() ?>/admin/exim/itemfinishgood" class="nav-link">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Item Finish Good</p>
                                    </a>
                                </li>
                                <div class="d-flex"></div>
                                <li class="nav-item d-flex">
                                    <a href="<?= base_url() ?>/admin/exim/agent" class="nav-link">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Agent</p>
                                    </a>
                                </li>
                                <li class="nav-item d-flex">
                                    <a href="<?= base_url() ?>/admin/exim/datacustomer" class="nav-link">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Data Customer</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/barangjadi/saldoawal"
                                        class="nav-link <?= $halaman == 'Karyawan' ? 'active' : 'DASHBOARD SDM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>SALDO AWAL</p>
                                    </a>
                        ...
                        <li class="nav-header">User Exim</li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-file-export"></i>
                                <p>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/exim/userloginbc"
                                        class="nav-link <?= $halaman == 'Exim' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Log User</p>
                                    </a>
                        ...
                        <?php endif ?>
                        <?php if (has_permission('potong')) : ?>
                        <li class="nav-header">Potong</li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-chart-pie"></i>
                                <p>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/potong/tipeitem"
                                        class="nav-link <?= $halaman == 'potong' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Tipe Item</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/potong/rcnproduksi"
                                        class="nav-link <?= $halaman == 'potong' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/admin/potong/prosesproduksi"
                                        class="nav-link <?= $halaman == 'potong' ? 'active' : 'DASHBOARD EXIM' ?>">
                                        <i class="far fa-file nav-icon"></i>
                                        <p>Proses Produksi</p>
                                    </a>
        ...
        <footer class="main-footer">
            <p>Page rendered in {elapsed_time} Second</p>
