                ...
                <div class="tab-content p-0">
                    <div class="tab-pane active" id="ajp3" style="position: relative;">
                        <div class="table-responsive">
                            <div class="table-responsive">
                                <table id="itemfgtabel" class="w-100 table table-bordered table-striped">
                                    <thead class="text-sm">
                                        <th>Kode</th>
                                        <th>Id MRP</th>
                                        <th>Finish Good</th>
...
$(document).ready(function() {
    ...
    var tajp3 = $('#itemfgtabel').DataTable({
        // dom": 'Blfrtip',
        "destroy": true,
        "processing": true,
        "serverSide": true,
        ...
        "ajax": {
            "url": "<?= site_url('admin/exim/itemfg/datatables') ?>",
            "type": "POST",
        },
        "lengthMenu": [
            [5, 10, 25, 100],
...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    $("#itemfgtabel").DataTable().ajax.reload();
                } else {
                    $('#negara').modal('show');
                }
            },
    ...
    $('#itemfgtabel tbody').on('click', '.btn-delete', function(e) {
