        ...
        for ($a = $form['tagihanawal']; $a <= $form['tagihanakhir']; $a->modify('+ 1 day')) {
            ...
            if ($cekoutmax4[0]['inoutm'] == null) {
                if ($cekoutmax2[0]['inoutm'] == null) {
                    $cekoutmaxjadi = $cekoutmax5;
                } else {
                    $cekoutmaxjadi = $cekoutmax2;
                }
            ...
            if ($form['unit'] == 'SATPAM') {
                if (date('Hi', strtotime($cekinmin[0]['cekin'])) > '1700') {
                    $jammasuk = '18:50:00';
                    $jampulang = '07:00:00';
                    $wk = strtotime(date('H:i', strtotime($cekinmin[0]['cekin'])))  - strtotime(date('H:i', strtotime($jammasuk)));
                    ...
                    $ak = strtotime(date('H:i', strtotime($jampulang))) - strtotime(date('H:i', strtotime($cekoutmaxjadi[0]['cout'])));
                    $lcepat = floor($ak  / 60);
                    if ($lcepat <= 0) {
                        $pcepat = $pcepat + 0;
                    } elseif ($lcepat <= 60) {
                    ...
                    $kj = (strtotime(date('H:i', strtotime($cekoutmaxjadi[0]['cout']))))  - (strtotime(date('H:i', strtotime($jampulang))));
                ...
                if (date('Hi', strtotime($cekinmin[0]['cekin'])) > '2100') {
                    ...
                    if (date('Hi', strtotime($cekinmin[0]['cekin'])) > '1330') {
                        $jammasuk = '14:50:00';
                        $jampulang = '23:00:00';
                        $wk = strtotime(date('H:i', strtotime($cekinmin[0]['cekin'])))  - strtotime(date('H:i', strtotime($jammasuk)));
                        $toterlambat = floor($wk  / 60);
