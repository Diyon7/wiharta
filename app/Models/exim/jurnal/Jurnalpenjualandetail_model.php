...
class Jurnalpenjualandetail_model extends Model
{
    protected $DBGroup = 'seconddb';
    protected $table      = 'beacukai_jurnal_penjualan_detail';
    protected $primaryKey = 'id';

    protected $allowedFields = ['seq', 'bukti', 'tgl', 'id', 'bpb', 'tglbpb', 'peb', 'tglpeb', 'inv', 'cus', 'item', 'satuan', 'qty', 'kgm', 'nilai', 'debit', 'kredit', 'kurs', 'mu'];
    ...
    {
        return $this->rh->select("tb_pengeluaran.`seq`,nobpb,tgbpb,nopeb,tgpeb,tb_pengeluaran.`inv`,namacus,kodeitem,desk,tb_pengeluaran.`satuan`,tb_pengeluaran.`qty`,tb_pengeluaran.`kgm`,fob,kurs,tb_pengeluaran.`mu`")
