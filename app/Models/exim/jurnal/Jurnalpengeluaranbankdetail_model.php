...
class Jurnalpengeluaranbankdetail_model extends Model
{
    protected $DBGroup = 'seconddb';
    protected $table      = 'beacukai_jurnal_pengeluaranbank_detail';
    protected $primaryKey = 'seq';

    protected $allowedFields = ['seq', 'kode', 'kode_bank', 'tgl', 'nilai', 'mu', 'kurs', 'debit', 'kredit', 'beacukai_jurnal_pembelian_id', 'nilai_peb', 'id_jurnal_pengeluaranbank'];
    ...
    function __construct(RequestInterface $request = null)
    {
        ...
        $this->dt = $this->db->table('beacukai_jurnal_pengeluaranbank_detail');
...
ORDER BY beacukai_jurnal_penjualan.`inv` ASC")
    ...
    {
        return $this->select("kode,kode_bank,tgl,nilai,nilai_peb,mu,kurs,debit,kredit")
            ->where("kode", $data)
            ->get()->getResultArray();
    }
