...
class Laporandiv2_model extends Model
{
    ...
    public function Alllaporan($data)
    {
        ...
        WHERE pembagian3.`pembagian3_nama` LIKE '" . $data['vendor'] . "' AND pembagian2.`pembagian2_nama` LIKE '" . $data['divisi'] . "' AND pegawai.`tgl_mulai_kerja` <= '" . $data['tgl2'] . "' AND (tgl_resign >= '" . $data['tgl'] . "' OR tgl_resign IS NULL OR tgl_resign='0000-00-00')")
            ->getResultArray();
