...
class Rekap extends BaseController
{
    ...
    public function Tabelabsenlaporanharian()
    {
        if ($this->request->isAJAX()) {
            ...
            $dkpabsenmasuk = $this->rekapall->Detailabsenmasuk($data);
            $dkpabsentidakmasuk = $this->rekapall->Detailabsentidakmasuk($data);
            ...
            $data = [
                ...
                'dkpharian' => $dkpharian,
                'dkpmasuk' => $dkpmasuk,
                'dkpabsenmasuk' => $dkpabsenmasuk,
                'dkpabsentidakmasuk' => $dkpabsentidakmasuk,
                'stm' => $stm,
                'sm' => $sm,
                's1' => $s1,
                's2' => $s2,
